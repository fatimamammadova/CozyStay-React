...
const Home = () => {
  ...
  return (
    <Index>
      ...
      <section className="apartment">
        <div className="page-container">
          <div className="apartment-inner">
            ...
            <div className="a-item">
              <span className="sub-title">Stay in the heart of New York</span>
              ...
              <div className="a-content">
                <p>
                  Located in Times Square, CozyStay apartment hotel provide a
                  peaceful, private retreat in the heart of one of the world’s
                  most iconic cities. Experience a sophisticated blend of
                  professional services and home comforts. We proudly offers a
                  full range of complimentary amenities and services that
                  provide you with everything you need for an inspiring stay.
                </p>
              </div>
      ...
      <section className="video" data-aos="fade-up" data-aos-duration="1500">
      ...
      <section className="apartment-types">
        <div className="page-container">
          <div className="title-inner">
            <span className="sub-title">EXTRAORDINARY ACCOMMODATIONS</span>
              ...
              <div className="ve-c-inner">
                ...
                <div className="ve-c-bottom">
                  <div className="ve-c-img">
                    <div
                      className="ve-c-img-inner"
                      data-aos="fade-down"
                      data-aos-duration="1500"
                    >
                      <img src="/img/vacation-experience-img-2.jpg" alt="" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="standarts">
        ...
        <div className="s-content" data-aos="fade-up" data-aos-duration="1500">
          <div className="page-container">
            <div className="s-content-inner">
              <span className="sub-title">High standards of hospitality</span>
